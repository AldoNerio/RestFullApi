...
namespace SocialMedia.Core.Services
{
    public class PostService : IPostService
    {
        ...
        public PostService(IUnitOfWork unitOfWork, IOptions<PaginationOptions> options) //Reglas de Negocio
        {
        ...
        public async Task InsertPosts(Post post)
        {
            ...
            if (userPost.Count() < 10)
            {
                ...
                {
                    throw new BusinessException("YOU ARE NOT ABLE TO PUBLISH THIS POST");
                }
            }
